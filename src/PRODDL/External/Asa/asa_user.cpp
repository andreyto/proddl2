...
* Copyright (c) 1993-2000 Lester Ingber.  All Rights Reserved.
* The LICENSE file must be included with ASA code.
***********************************************************************/

#define USER_ID \
"/* $Id: asa_user.cpp,v 1.3 2000/03/29 08:08:26 andrey Exp $ */"

#include "PRODDL/External/Asa/user.h"
...
asa_main (
	   ...
	   int *main_exit_code,
	   double *main_lower_bound,
	   double *main_upper_bound,
	   int main_nparam
#endif
)
#else /* ASA_LIB */
...
#endif /* HAVE_ANSI */
{
  ...
  FILE *ptr_options;
  char read_option[80];
  char read_if[4], read_FALSE[6], read_comm1[3], read_ASA_SAVE[9], read_comm2[3];
  int read_int;
#if INT_LONG
  LONG_INT read_long;
#endif
  ...
  if ((rand_seed =
    ...
    {
      strcpy (exit_msg, "main()/asa_main(): rand_seed");
      Exit_USER (exit_msg);
      return (-2);
    }
#if ASA_LIB
  ...
  *rand_seed = 696969;
  ...
  if ((parameter_dimension =
    ...
    {
      strcpy (exit_msg, "main()/asa_main(): parameter_dimension");
      Exit_USER (exit_msg);
      return (-2);
    }
  if ((exit_code = (int *) calloc (1, sizeof (int))) == NULL)
    {
      strcpy (exit_msg, "main()/asa_main(): exit_code");
      Exit_USER (exit_msg);
      return (-2);
    }
  if ((cost_flag = (int *) calloc (1, sizeof (int))) == NULL)
    {
      strcpy (exit_msg, "main()/asa_main(): cost_flag");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  if ((USER_OPTIONS =
    ...
    {
      strcpy (exit_msg, "main()/asa_main(): USER_DEFINES");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  USER_OPTIONS->User_Initial_Parameters = TRUE; //AT
  ...
  USER_OPTIONS->Random_Array_Dim = 256;
  if ((USER_OPTIONS->Random_Array =
       (double *) calloc (USER_OPTIONS->Random_Array_Dim, sizeof (double))) == NULL)
    {
      strcpy (exit_msg, "main()/asa_main(): USER_OPTIONS->Random_Array");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  if ((USER_OPTIONS->Asa_Data_Ptr =
    ...
    {
      strcpy (exit_msg, "main()/asa_main(): USER_OPTIONS->Asa_Data_Ptr");
      Exit_USER (exit_msg);
      return (-2);
    }
#endif /* ASA_TEMPLATE */
  ...
  if ((USER_OPTIONS->Asa_Out_File =
    ...
    {
      strcpy (exit_msg, "main()/asa_main(): USER_OPTIONS->Asa_Out_File");
      Exit_USER (exit_msg);
      return (-2);
    }
#endif
  ...
  *parameter_dimension = 4;
  ...
  //AT
  *parameter_dimension = main_nparam;
  ...
  *parameter_dimension = 2;
  ...
  if ((parameter_lower_bound =
    ...
    {
      strcpy (exit_msg, "main()/asa_main(): parameter_lower_bound");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  if ((parameter_upper_bound =
    ...
    {
      strcpy (exit_msg, "main()/asa_main(): parameter_upper_bound");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  if ((cost_parameters =
    ...
    {
      strcpy (exit_msg, "main()/asa_main(): cost_parameters");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  if ((parameter_int_real =
    ...
    {
      strcpy (exit_msg, "main()/asa_main(): parameter_int_real");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  if ((cost_tangents =
    ...
    {
      strcpy (exit_msg, "main()/asa_main(): cost_tangents");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  if (USER_OPTIONS->Curvature_0 == FALSE || USER_OPTIONS->Curvature_0 == -1)
    {
      ...
      if ((cost_curvature =
	   (double *) calloc ((*parameter_dimension) *
			      ...
			      sizeof (double))) == NULL)
	{
	  strcpy (exit_msg, "main()/asa_main(): cost_curvature");
	  Exit_USER (exit_msg);
	  return (-2);
	}
    }
  ...
  for (index = 0; index < *parameter_dimension; ++index)
    parameter_lower_bound[index] = main_lower_bound[index];
  for (index = 0; index < *parameter_dimension; ++index)
    parameter_upper_bound[index] = main_upper_bound[index];
  for (index = 0; index < *parameter_dimension; ++index)
    parameter_int_real[index] = REAL_TYPE;
  for (index = 0; index < *parameter_dimension; ++index)
    cost_parameters[index] = main_cost_parameters[index];
  }
#endif
  ...
  for (n_asa = 1; n_asa <= *parameter_dimension; n_asa++)
      ...
      for (n_trajectory = 0; n_trajectory < 3; ++n_trajectory)
	{
	  ...
	  if (USER_OPTIONS->Fit_Local >= 1)
	    {
	      cost_value = fitloc (cost_parameters,
				   parameter_lower_bound,
				   parameter_upper_bound,
				   cost_tangents,
				   cost_curvature,
...
#endif /* MULTI_MIN */
#if ASA_SAVE
  free (USER_OPTIONS->Random_Array);
#endif
  free (USER_OPTIONS);
...
#endif
{
  ...
  if ((USER_OPTIONS->User_Parameter_Temperature =
    ...
    {
      strcpy (exit_msg, "initialize_parameters(): USER_OPTIONS->User_Parameter_Temperature");
      Exit_USER (exit_msg);
      return (-2);
    }
#if ASA_TEMPLATE
  ...
  if ((USER_OPTIONS->User_Cost_Temperature =
    ...
    {
      strcpy (exit_msg, "initialize_parameters(): USER_OPTIONS->User_Cost_Temperature");
      Exit_USER (exit_msg);
      return (-2);
    }
#if ASA_TEMPLATE
  ...
  if ((USER_OPTIONS->User_Delta_Parameter =
    ...
    {
      strcpy (exit_msg, "initialize_parameters(): USER_OPTIONS->User_Delta_Parameter");
      Exit_USER (exit_msg);
      return (-2);
    }
#if ASA_TEMPLATE
  ...
  if ((USER_OPTIONS->User_Quench_Param_Scale =
    ...
    {
      strcpy (exit_msg, "initialize_parameters(): USER_OPTIONS->User_Quench_Param_Scale");
      Exit_USER (exit_msg);
      return (-2);
    }
#if ASA_TEMPLATE
  ...
  if ((USER_OPTIONS->User_Quench_Cost_Scale =
       (double *) calloc (1, sizeof (double))) == NULL)
    {
      strcpy (exit_msg, "initialize_parameters(): USER_OPTIONS->User_Quench_Cost_Scale");
      Exit_USER (exit_msg);
      return (-2);
    }
#if ASA_TEMPLATE
  ...
  if ((USER_OPTIONS->User_Temperature_Ratio =
    ...
    {
      strcpy (exit_msg, "initialize_parameters(): USER_OPTIONS->User_Temperature_Ratio");
      Exit_USER (exit_msg);
      return (-2);
    }
#if ASA_TEMPLATE
  ...
  if ((USER_OPTIONS->Bias_Generated =
    ...
    {
      strcpy (exit_msg, "initialize_parameters(): USER_OPTIONS->Bias_Generated");
      Exit_USER (exit_msg);
      return (-2);
    }
#endif
  ...
  if ((USER_OPTIONS->Coarse_Resolution =
    ...
    {
      strcpy (exit_msg, "initialize_parameters(): USER_OPTIONS->Coarse_Resolution");
      Exit_USER (exit_msg);
      return (-2);
    }
#if ASA_TEMPLATE
  ...
  if ((USER_OPTIONS->Queue_Resolution =
    ...
    {
      strcpy (exit_msg, "initialize_parameters(): USER_OPTIONS->Queue_Resolution");
      Exit_USER (exit_msg);
      return (-2);
    }
#endif /* ASA_RESOLUTION */
  ...
  if ((USER_OPTIONS->Multi_Grid =
    ...
    {
      strcpy (exit_msg, "initialize_parameters(): USER_OPTIONS->Multi_Grid");
      Exit_USER (exit_msg);
      return (-2);
    }
  for (multi_index = 0; multi_index < MULTI_NUMBER; ++multi_index)
	...
	{
	  strcpy (exit_msg, "initialize_parameters(): USER_OPTIONS->Multi_Params[multi_index]");
	  Exit_USER (exit_msg);
	  return (-2);
	}
    }
  ...
  for (index = 0; index < *parameter_dimension; ++index)
	...
	(parameter_upper_bound[index] -
	 parameter_lower_bound[index]) / 100.0;
    }
  USER_OPTIONS->Multi_Specify = 0;
#endif /* ASA_TEMPLATE */
#endif /* MULTI_MIN */
...
#if ASA_SAVE
  /* random_array[] local to all of user.c set at top of file */
#else
...
#endif /* HAVE_ANSI */
{
  ...
  if ((recur_parameter_dimension =
       (ALLOC_INT *) calloc (1, sizeof (ALLOC_INT))) == NULL)
    {
      strcpy (exit_msg, "main()/asa_main(): recur_parameter_dimension");
      Exit_USER (exit_msg);
      return (-2);
    }
  if ((recur_exit_code = (int *) calloc (1, sizeof (int))) == NULL)
    {
      strcpy (exit_msg, "main()/asa_main(): recur_exit_code");
      Exit_USER (exit_msg);
      return (-2);
    }
  if ((recur_cost_flag = (int *) calloc (1, sizeof (int))) == NULL)
    {
      strcpy (exit_msg, "main()/asa_main(): recur_cost_flag");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  if ((RECUR_USER_OPTIONS =
       (USER_DEFINES *) calloc (1, sizeof (USER_DEFINES))) == NULL)
    {
      strcpy (exit_msg, "main()/asa_main(): RECUR_USER_OPTIONS");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  *recur_parameter_dimension = 2;
  ...
  if ((recur_parameter_lower_bound =
    ...
    {
      strcpy (exit_msg, "main()/asa_main(): recur_parameter_lower_bound");
      Exit_USER (exit_msg);
      return (-2);
    }
  if ((recur_parameter_upper_bound =
    ...
    {
      strcpy (exit_msg, "main()/asa_main(): recur_parameter_upper_bound");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  if ((recur_cost_parameters =
    ...
    {
      strcpy (exit_msg, "main()/asa_main(): recur_cost_parameters");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  if ((recur_parameter_int_real =
    ...
    {
      strcpy (exit_msg, "main()/asa_main(): recur_parameter_int_real");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  if ((recur_cost_tangents =
    ...
    {
      strcpy (exit_msg, "main()/asa_main(): recur_cost_tangents");
      Exit_USER (exit_msg);
      return (-2);
    }
      ...
      if ((recur_cost_curvature =
	   (double *) calloc ((*recur_parameter_dimension)
			      * (*recur_parameter_dimension),
			      sizeof (double))) == NULL)
	{
	  strcpy (exit_msg, "main()/asa_main(): recur_cost_curvature");
	  Exit_USER (exit_msg);
	  return (-2);
	}
    }
  ...
  if ((RECUR_USER_OPTIONS->Asa_Data_Dbl =
       (double *) calloc (RECUR_USER_OPTIONS->Asa_Data_Dim_Dbl, sizeof (double))) == NULL)
    {
      strcpy (exit_msg, "main()/asa_main(): RECUR_USER_OPTIONS->Asa_Data_Dbl");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  if ((recur_rand_seed =
       (LONG_INT *) calloc (1, sizeof (LONG_INT))) == NULL)
    {
      strcpy (exit_msg, "main()/asa_main(): recur_rand_seed");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  *recur_rand_seed = 696969;
  ...
  if ((RECUR_USER_OPTIONS->Asa_Out_File =
    ...
    {
      strcpy (exit_msg, "main()/asa_main(): RECUR_USER_OPTIONS->Asa_Out_File");
      Exit_USER (exit_msg);
      return (-2);
    }
#if ASA_TEMPLATE_SELFOPT
...
#endif
{
  ...
  if ((RECUR_USER_OPTIONS->User_Parameter_Temperature =
       (double *) calloc (*recur_parameter_dimension,
			  sizeof (double))) == NULL)
    {
      strcpy (exit_msg, "recur_initialize_parameters(): RECUR_USER_OPTIONS->User_Parameter_Temperature");
      Exit_USER (exit_msg);
      return (-2);
    }
  for (index = 0; index < *recur_parameter_dimension; ++index)
  ...
  if ((RECUR_USER_OPTIONS->User_Cost_Temperature =
       (double *) calloc (1, sizeof (double))) == NULL)
    {
      strcpy (exit_msg, "recur_initialize_parameters(): RECUR_USER_OPTIONS->User_Cost_Temperature");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  if ((RECUR_USER_OPTIONS->User_Delta_Parameter =
       (double *) calloc (*recur_parameter_dimension,
			  sizeof (double))) == NULL)
    {
      strcpy (exit_msg, "recur_initialize_parameters(): RECUR_USER_OPTIONS->User_Delta_Parameter");
      Exit_USER (exit_msg);
      return (-2);
    }
  for (index = 0; index < *recur_parameter_dimension; ++index)
  ...
  if ((RECUR_USER_OPTIONS->User_Quench_Param_Scale =
       (double *) calloc (*recur_parameter_dimension,
			  sizeof (double))) == NULL)
    {
      strcpy (exit_msg, "recur_initialize_parameters(): RECUR_USER_OPTIONS->User_Quench_Param_Scale");
      Exit_USER (exit_msg);
      return (-2);
    }
#if ASA_TEMPLATE
  ...
  if ((RECUR_USER_OPTIONS->User_Quench_Cost_Scale =
       (double *) calloc (1, sizeof (double))) == NULL)
    {
      strcpy (exit_msg, "recur_initialize_parameters(): RECUR_USER_OPTIONS->User_Quench_Cost_Scale");
      Exit_USER (exit_msg);
      return (-2);
    }
#if ASA_TEMPLATE
  ...
  if ((RECUR_USER_OPTIONS->User_Temperature_Ratio =
       (double *) calloc (*recur_parameter_dimension,
			  sizeof (double))) == NULL)
    {
      strcpy (exit_msg, "recur_initialize_parameters(): RECUR_USER_OPTIONS->User_Temperature_Ratio");
      Exit_USER (exit_msg);
      return (-2);
    }
#if ASA_TEMPLATE
  ...
  if ((RECUR_USER_OPTIONS->Bias_Generated =
    ...
    {
      strcpy (exit_msg, "recur_initialize_parameters(): RECUR_USER_OPTIONS->Bias_Generated");
      Exit_USER (exit_msg);
      return (-2);
    }
#if ASA_TEMPLATE
  ...
  if ((RECUR_USER_OPTIONS->Coarse_Resolution =
    ...
    {
      strcpy (exit_msg, "recur_initialize_parameters(): RECUR_USER_OPTIONS->Coarse_Resolution");
      Exit_USER (exit_msg);
      return (-2);
    }
#endif
...
#if ASA_QUEUE
#if ASA_RESOLUTION
  RECUR_USER_OPTIONS->Queue_Resolution = RECUR_USER_OPTIONS->Coarse_Resolution;
#else /* ASA_RESOLUTION */
  if ((RECUR_USER_OPTIONS->Queue_Resolution =
       (double *) calloc (*parameter_dimension, sizeof (double))
      ) == NULL)
    {
      strcpy (exit_msg, "recur_initialize_parameters(): RECUR_USER_OPTIONS->Queue_Resolution");
      Exit_USER (exit_msg);
      return (-2);
    }
#endif /* ASA_RESOLUTION */
...
#endif
{
  ...
  if ((rand_seed =
       (LONG_INT *) calloc (1, sizeof (LONG_INT))) == NULL)
    {
      strcpy (exit_msg, "recur_cost_function(): rand_seed");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  if ((USER_OPTIONS =
       (USER_DEFINES *) calloc (1, sizeof (USER_DEFINES))) == NULL)
    {
      strcpy (exit_msg, "recur_cost_function(): USER_OPTIONS");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  if ((parameter_dimension =
       (ALLOC_INT *) calloc (1, sizeof (ALLOC_INT))) == NULL)
    {
      strcpy (exit_msg, "recur_cost_function(): parameter_dimension");
      Exit_USER (exit_msg);
      return (-2);
    }
  if ((exit_code = (int *) calloc (1, sizeof (int))) == NULL)
    {
      strcpy (exit_msg, "recur_cost_function(): exit_code");
      Exit_USER (exit_msg);
      return (-2);
    }
  if ((cost_flag = (int *) calloc (1, sizeof (int))) == NULL)
    {
      strcpy (exit_msg, "recur_cost_function(): cost_flag");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  *parameter_dimension = 4;
  ...
  if ((parameter_lower_bound =
    ...
    {
      strcpy (exit_msg, "recur_cost_function(): parameter_lower_bound");
      Exit_USER (exit_msg);
      return (-2);
    }
  if ((parameter_upper_bound =
    ...
    {
      strcpy (exit_msg, "recur_cost_function(): parameter_upper_bound");
      Exit_USER (exit_msg);
      return (-2);
    }
  if ((cost_parameters =
    ...
    {
      strcpy (exit_msg, "recur_cost_function(): cost_parameters");
      Exit_USER (exit_msg);
      return (-2);
    }
  if ((parameter_int_real =
    ...
    {
      strcpy (exit_msg, "recur_cost_function(): parameter_int_real");
      Exit_USER (exit_msg);
      return (-2);
    }
  if ((cost_tangents =
    ...
    {
      strcpy (exit_msg, "recur_cost_function(): cost_tangents");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  if (USER_OPTIONS->Curvature_0 == FALSE || USER_OPTIONS->Curvature_0 == -1)
    {
      if ((cost_curvature =
	   (double *) calloc ((*parameter_dimension) *
			      ...
			      sizeof (double))) == NULL)
	{
	  strcpy (exit_msg, "recur_cost_function(): cost_curvature");
	  Exit_USER (exit_msg);
	  return (-2);
	}
    }
  ...
  if ((USER_OPTIONS->Asa_Data_Dbl =
       (double *) calloc (USER_OPTIONS->Asa_Data_Dim_Dbl, sizeof (double))) == NULL)
    {
      strcpy (exit_msg, "recur_cost_function(): USER_OPTIONS->Asa_Data_Dbl");
      Exit_USER (exit_msg);
      return (-2);
    }
  ...
  if ((USER_OPTIONS->Asa_Out_File =
    ...
    {
      strcpy (exit_msg, "recur_cost_function(): USER_OPTIONS->Asa_Out_File");
      Exit_USER (exit_msg);
      return (-2);
    }
#if ASA_TEMPLATE_SELFOPT
...
main ()
{
  ...
  if ((main_cost_parameters =
    ...
    {
      strcpy (exit_msg, "ASA_TEMPLATE_LIB main(): main_cost_parameters");
      Exit_USER (exit_msg);
      return (-2);
    }

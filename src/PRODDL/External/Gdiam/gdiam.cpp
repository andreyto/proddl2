...
public:
    ...
    int  size() const {
        return  p_pnt_right - p_pnt_left + 1;
    }
...
public:
    GTreeDiamAlg( gdiam_point  * arr, int  size ) {
        tree.init( arr, size );
        //diam = 0;
                                ...
                                gdiam_real  eps )
{
    ...
    GTreeDiamAlg  * pAlg = new  GTreeDiamAlg( start, size );
...
public:
   ...
   point and slope */
    ...
    void  compute_min_bbox_inner( bbox_2d_info   & min_bbox,
                                  gdiam_real  & min_area ) {
        int        u, v, s, t;
        double     ang1, ang2, ang3, tmp_area;
                                    ...
                                    int  sample_size )
{
    ...
    // points.
    srand(1); // get reproducible results

...
***********************************************************************/
 ...
 /* $Id: asa_user.h,v 1.5 2000/03/29 22:54:07 andrey Exp $ */
...
#define OPTIONAL_PTR_TYPE double
#endif
#endif
...
extern char exit_msg[]; /*AT: moved defintion to asa.c to avoid Multiple definitio error in c++*/
